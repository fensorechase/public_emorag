...
python main.py \
  ...
  --output v2_results_test_run_ai71.json \
  --competition-format \
  --competition-output v2_results_final_challengeday_submission.jsonl \
  --use-aws \
  --retriever-type hybrid \
  --top-k-dense 30 \
  --top-k-sparse 30 \
  --top-k-final 10 \
  --falcon-mode ai71 \
  --ai71-api-key "ai71-api-f0780093-061a-4f78-acc1-47343a409a28" \
  --batch-size 5 \
  --n-parallel 10 \
  --n-retries 3
"""
